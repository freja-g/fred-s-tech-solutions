...
const StaffDashboard = () => {
  ...
  return (
    <div className="container max-w-4xl py-4 sm:py-8 space-y-6 sm:space-y-8">
          ...
          <h2 className="font-semibold mb-4 flex items-center gap-2">
           ...
           <div className="grid grid-cols-1 min-[360px]:grid-cols-2 gap-3 sm:gap-4">
            {statCards.slice(0, 2).map((s) => (
               <div key={s.label} className="min-w-0 p-3 sm:p-4 bg-accent/5 rounded-lg border border-accent/10">
